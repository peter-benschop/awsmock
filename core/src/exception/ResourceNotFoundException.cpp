...
namespace AwsMock::Core {
    ...
    ResourceNotFoundException::ResourceNotFoundException(int code)
            : Poco::Exception(code) {
    }

    ResourceNotFoundException::ResourceNotFoundException(const std::string &msg, int code)
            : Poco::Exception(msg, code) {
    }

    ResourceNotFoundException::ResourceNotFoundException(const std::string &msg, const std::string &arg, int code)
            : Poco::Exception(msg, arg, code) {
    }

    ResourceNotFoundException::ResourceNotFoundException(const std::string &msg, const Poco::Exception &exc, int code)
            : Poco::Exception(msg, exc,
                              code) {
    }

    ResourceNotFoundException::ResourceNotFoundException(const ResourceNotFoundException &exc)
            : Poco::Exception(exc) {
    }
