...
#ifndef AWSMOCK_RESOURCE_FACTORY_TRANSFERFACTORY_H
#define AWSMOCK_RESOURCE_FACTORY_TRANSFERFACTORY_H
...
namespace AwsMock::Resource::Factory {
    ...
    class TransferFactory : public IFactory {
...
#endif // AWSMOCK_RESOURCE_FACTORY_TRANSFERFACTORY_H
