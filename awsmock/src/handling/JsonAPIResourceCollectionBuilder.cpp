#include "awsmock/resource/handling/JsonAPIResourceCollectionBuilder.h"

namespace AwsMock {

    JsonAPIResourceCollectionBuilder::JsonAPIResourceCollectionBuilder() : links(), resourceRootURL(), metadata(), structRoot(), resourceBasic(), dataArrayRoot() {}
