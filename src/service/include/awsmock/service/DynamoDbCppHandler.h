...
#ifndef AWSMOCK_SERVICE_DYNAMODB_CPP_HANDLER_H
#define AWSMOCK_SERVICE_DYNAMODB_CPP_HANDLER_H
...
namespace AwsMock::Service {
  ...
  /**
   * AWS DynamoDB CPP mock handler
   */
  class DynamoDbCppHandler : public virtual AbstractHandler {
    ...
    public:
       ...
       */
      DynamoDbCppHandler(Core::Configuration &configuration, Core::MetricService &metricService);
...
#endif // AWSMOCK_SERVICE_DYNAMODB_CPP_HANDLER_H
