...
#ifndef AWSMOCK_SERVICE_SQSMONITORING_H
#define AWSMOCK_SERVICE_SQSMONITORING_H
...
namespace AwsMock::Service {
  ...
  public:
     ...
     */
    explicit SQSMonitoring(Core::Configuration &configuration, Core::MetricService &metricService, Poco::Condition &condition);
...
#endif // AWSMOCK_SERVICE_SQSMONITORING_H
