...
#define DYNAMODB_MONITORING_DEFAULT_PERIOD 60000

namespace AwsMock::Service {

  class DynamoDbMonitoring : public Poco::Runnable {
  ...
  public:
     ...
     */
    explicit DynamoDbMonitoring(Core::Configuration &configuration, Core::MetricService &metricService, Poco::Condition &condition);
