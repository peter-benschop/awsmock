...
#ifndef AWSMOCK_SERVICE_SNSJAVAHANDLER_H
#define AWSMOCK_SERVICE_SNSJAVAHANDLER_H
...
namespace AwsMock::Service {
   ...
   */
  class SNSJava2Handler : public virtual AbstractHandler {
  ...
  public:
     ...
     */
    SNSJava2Handler(Core::Configuration &configuration, Core::MetricService &metricService, Poco::Condition &condition);
...
#endif // AWSMOCK_SERVICE_SNSJAVAHANDLER_H
