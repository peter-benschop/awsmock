...
namespace AwsMock::Service {
    ...
    http::response<http::string_body> SQSHandler::HandlePostRequest(const http::request<http::string_body> &request, const std::string &region, const std::string &user) {
            ...
            switch (clientCommand.command) {
                ...
                case Dto::Common::SqsCommandType::CREATE_QUEUE: {
                    ...
                    if (clientCommand.contentType == "json") {
                        ...
                        sqsRequest.queueUrl = Core::AwsUtils::CreateSQSQueueUrl(Core::Configuration::instance(), sqsRequest.queueName);
                        ...
                        SendOkResponse(request, sqsResponse.ToJson());
                        ...
                        std::string queueUrl = Core::AwsUtils::CreateSQSQueueUrl(Core::Configuration::instance(), queueName);
                        ...
                        Dto::SQS::CreateQueueResponse sqsResponse = _sqsService.CreateQueue(sqsRequest);
                        SendOkResponse(request, sqsResponse.ToXml());
                ...
                case Dto::Common::SqsCommandType::GET_QUEUE_ATTRIBUTES: {
                    ...
                    SendOkResponse(request, clientCommand.contentType == "json" ? sqsResponse.ToJson() : sqsResponse.ToXml());
                ...
                case Dto::Common::SqsCommandType::SEND_MESSAGE: {
                    ...
                    if (clientCommand.contentType == "json") {
                        ...
                        sqsRequest = {.queueUrl = queueUrl, .body = body, .messageAttributes = attributes, .messageId = Core::AwsUtils::CreateRequestId()};
                    }
                ...
                case Dto::Common::SqsCommandType::UNKNOWN: {
                    log_error << "Bad request, method: POST clientCommand: " << Dto::Common::SqsCommandTypeToString(clientCommand.command);
                    throw Core::ServiceException("Bad request, method: POST clientCommand: " + Dto::Common::SqsCommandTypeToString(clientCommand.command));
                }
            }
