...
namespace AwsMock::Service {
    ...
    CognitoHandler::CognitoHandler(Core::Configuration &configuration) : CognitoCmdHandler(configuration), _configuration(configuration) {}
    ...
    void CognitoHandler::handlePost(Poco::Net::HTTPServerRequest &request, Poco::Net::HTTPServerResponse &response, const std::string &region, const std::string &user) {
        ...
        try {
            ...
            switch (userAgent.type) {
                ...
                case Dto::Common::UserAgentType::AWS_CLI:
                    return CognitoCliHandler::handlePost(request, response, region, user);
                case Dto::Common::UserAgentType::AWS_SDK_JAVA1:
                    break;
                case Dto::Common::UserAgentType::AWS_SDK_JAVA2:
                    return CognitoJava2Handler::handlePost(request, response, region, user);
                case Dto::Common::UserAgentType::AWS_SDK_CPP:
                    return CognitoJava2Handler::handlePost(request, response, region, user);
            }
