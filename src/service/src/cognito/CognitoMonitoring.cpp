...
namespace AwsMock::Service {
  ...
  CognitoMonitoring::CognitoMonitoring(Core::Configuration &configuration, Core::MetricService &metricService, Poco::Condition &condition)
      : _logger(Poco::Logger::get("CognitoMonitoring")), _configuration(configuration), _metricService(metricService), _cognitoDatabase(Database::CognitoDatabase::instance()), _condition(condition), _running(false) {
