...
namespace AwsMock::Service {
  ...
  SNSMonitoring::SNSMonitoring(Core::Configuration &configuration, Core::MetricService &metricService, Poco::Condition &condition)
      : _logger(Poco::Logger::get("SNSMonitoring")), _configuration(configuration), _metricService(metricService), _condition(condition), _running(false),_snsDatabase(Database::SNSDatabase::instance()) {
