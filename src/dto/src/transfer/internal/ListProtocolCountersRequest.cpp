...
namespace AwsMock::Dto::Transfer {
    ...
    void ListProtocolCountersRequest::FromJson(const std::string &jsonString) {
    ...
    std::string ListProtocolCountersRequest::ToJson() const {
    ...
    std::string ListProtocolCountersRequest::ToString() const {
        std::stringstream ss;
        ss << *this;
        return ss.str();
    }

    std::ostream &operator<<(std::ostream &os, const ListProtocolCountersRequest &r) {
        os << "ListProtocolCountersRequest=" << r.ToJson();
        return os;
    }
