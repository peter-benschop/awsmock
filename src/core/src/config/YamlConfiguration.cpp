...
YamlConfiguration::Initialize()
{
    ...
    DefineStringProperty("awsmock.service.transfer.base.dir", "AWSMOCK_SERVICE_TRANSFER_BASE_DIR",
    ...
    DefineStringProperty("awsmock.service.secretsmanager.http.host", "AWSMOCK_SERVICE_SECRETSMANAGER_HOST",
                         "localhost");
    ...
    DefineIntProperty("awsmock.service.secretsmanager.http.max.threads", "AWSMOCK_SERVICE_SECRETSMANAGER_MAX_THREADS",
                      50);
...
void
YamlConfiguration::DefineStringProperty(const std::string &key, const std::string &envProperty,
...
void
YamlConfiguration::DefineBoolProperty(const std::string &key, const std::string &envProperty, const bool defaultValue)
{
    if (getenv(envProperty.c_str()) != nullptr)
    {
        _yamlConfig[key] = envProperty.c_str();
...
void
YamlConfiguration::DefineIntProperty(const std::string &key, const std::string &envProperty, int defaultValue)
{
    if (getenv(envProperty.c_str()) != nullptr)
    {
        _yamlConfig[key] = envProperty.c_str();
...
std::string
YamlConfiguration::GetFilename() const
{
    if (_filename.empty())
    {
...
void
YamlConfiguration::SetFilename(const std::string &filename)
{
    if (filename.empty())
    {
...
void
YamlConfiguration::SetValue(const std::string &key, const std::string &value)
{
    if (!HasProperty(key))
    {
...
void
YamlConfiguration::SetValueByPath(const std::string &path, const std::string &value)
{
...
void
YamlConfiguration::SetValue(const std::string &key, const bool value)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
void
YamlConfiguration::SetValue(const std::string &key, const int value)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
std::string
YamlConfiguration::GetValueString(const std::string &key)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
int
YamlConfiguration::GetValueInt(const std::string &key)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
long
YamlConfiguration::GetValueLong(const std::string &key)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
bool
YamlConfiguration::GetValueBool(const std::string &key)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
double
YamlConfiguration::GetValueDouble(const std::string &key)
{
    if (!HasProperty(key))
    {
        throw CoreException("Property not found, key: " + key);
...
std::string
YamlConfiguration::GetAppName()
{
    return PROJECT_NAME;
}

std::string
YamlConfiguration::GetVersion()
{
    return PROJECT_VERSION;
}

std::string
YamlConfiguration::ToString() const
{
    std::stringstream ss;
    ss << *this;
    return ss.str();
...
void
YamlConfiguration::WriteFile(const std::string &filename) const
{
...
void
YamlConfiguration::AddToEnvList(const std::string &key, const std::string &value)
{
    _envList[key] = value;
}

void
YamlConfiguration::ApplyEnvSettings() const
{
...
bool
YamlConfiguration::HasProperty(const std::string &key)
{
    std::vector<std::string> paths = StringUtils::Split(key, '.');
...
std::ostream &
operator<<(std::ostream &os, const YamlConfiguration &s)
{
    os << "Configuration={";
    //        for (const auto &it: s) {
