...
namespace AwsMock::Core {
  ...
  std::string JsonLogFormatter::priorityToString(Poco::Message::Priority p) {
    ...
    case Poco::Message::Priority::PRIO_INFORMATION:return PRIORITY_STR_INFORMATION;
    case Poco::Message::Priority::PRIO_DEBUG:return PRIORITY_STR_DEBUG;
    case Poco::Message::Priority::PRIO_TRACE:return PRIORITY_STR_TRACE;
    default:return PRIORITY_STR_NOTICE;
    }
  }
