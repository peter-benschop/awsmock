...
namespace AwsMock::Core {
    ...
    CurlResponse CurlUtils::SendUnixSocketRequest(const std::string &method, const std::string &path, const std::string &body, const std::string &dockerSocket) {
        ...
        // Set options
        curl_easy_setopt(curl, CURLOPT_UNIX_SOCKET_PATH, dockerSocket.c_str());
        ...
        log_debug << "Request send to docker daemon, state: " << status << " socket: " << dockerSocket;
    ...
    CurlResponse CurlUtils::SendUnixSocketFileRequest(const std::string &method, const std::string &path, const std::string &header, const std::string &fileName, const std::string &dockerSocket) {
