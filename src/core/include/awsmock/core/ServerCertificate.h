...
#ifndef AWSMOCK_CORE_SERVER_CERTIFICATE_HPP
#define AWSMOCK_CORE_SERVER_CERTIFICATE_HPP
...
*/
inline void LoadCertificate(boost::asio::ssl::context &ctx) {
    /*
...
#endif// AWSMOCK_CORE_SERVER_CERTIFICATE_HPP
