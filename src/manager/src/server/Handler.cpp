...
namespace AwsMock::Manager {
    ...
    boost::beast::http::response<boost::beast::http::string_body> Handler::HandleGetRequest(boost::beast::http::request<boost::beast::http::string_body> &request) {
        ...
        try {
            ...
            return SendInternalServerErrorResponse(request, exc.message());
        }
    }
    ...
    boost::beast::http::response<boost::beast::http::string_body> Handler::SendInternalServerErrorResponse(boost::beast::http::request<boost::beast::http::string_body> &request, const std::string &body) {
        // Prepare the response message
        boost::beast::http::response<boost::beast::http::string_body> response;
        response.version(request.version());
